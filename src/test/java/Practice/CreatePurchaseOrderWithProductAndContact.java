...
//	   }
	  ...
	  // wd.ImplicitlyWaits(driver);
	   ...
	   Set<String> childHandles11 = driver.getWindowHandles();
	  
	   
//   for(String handle14:childHandles11) {	  
//	   if(!handle14.equals(mainHandle)) {		
//		   driver.switchTo().window(handle14);
//		   
//		   driver.manage().window().maximize();
//	   }
//   }
